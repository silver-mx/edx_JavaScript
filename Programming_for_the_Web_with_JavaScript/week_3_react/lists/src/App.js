...
class App extends Component {
  ...
  handleAddItem(s) {
      // Implement this function!
      console.log('handleAddItem=>', s);
      var items = this.state.items;
      var itemsForLst = this.state.items[s.newItem.listName] || [];
      items[s.newItem.listName] = [...itemsForLst, {name: s.newItem.itemName}];
